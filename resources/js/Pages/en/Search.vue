            ...
            <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue text-right">
                ...
                <header class="mb-4 lg:mb-b6 not-format mr-4">
                    ...
                    <details class="dropdown">
                        <summary class="m-1 btn"><i class="fa-solid fa-ellipsis" style="color: #fc6600;"></i></summary>
                        <ul class="p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52">
                            <li @click="useClipboard"><a><i class="fa-regular fa-copy" style="color: #fc6600;"></i>کپی</a>
                            </li>
                        </ul>
                    </details>
                    ...
                    <details class="dropdown">
                        <summary class="m-1 btn">
                            <p class="text-gray-800">
                                ترجمه
                                <i class="fa-solid fa-caret-down" style="color: #fc6600;"></i>
                            </p>
                        </summary>
                        <ul class="p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52">
